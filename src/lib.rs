...
#[post("/collections")]
async fn post_a_collection(data: web::Data<AppState>, body: web::Json<CollectionSchema>) -> impl Responder {
    let query_result = query_as::<Postgres, Collection>(
        "INSERT INTO collections (title, description, location, contact_information, listings, rules) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *",
    )
